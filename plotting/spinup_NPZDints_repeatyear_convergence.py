"""
Test for convergence in spin-up runs by plotting the difference between 
successive runs
...
for region in regions:
    ...
    ##########################################################
    ##  Plot differences between successive spin-up runs    ##
    ##########################################################
...
for region in regions:
    for variable_info in plot_variables:
        ...
        ax.set_title(
            f'{region} – {var_name} spin-up convergence',
            loc='left',
            fontsize=14,
            fontweight='bold'
        )
