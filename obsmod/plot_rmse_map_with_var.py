...
station_rmse['high_variability'] = (
    station_rmse['obs_std'] >= std_threshold
)
...
low = ~station_rmse['high_variability']
high = station_rmse['high_variability']
...
out_fn = out_dir / (
    f'{otype}_{year}_{vn}_station_rmse_with_var_map.png'
)
