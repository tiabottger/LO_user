...
def get_sta_dict(job_name):
    ...
    if job_name == 'orca':
        ...
        # DM defined 10/1/2025 to mirror Penn Cove experimental plan
        sta_dict = {
    ...
    elif job_name == 'ecology_subset':
        sta_dict = {
            'SAR003': (48.10833, -122.49000),
            'PSS019': (48.01167, -122.30000),
            'SKG003': (48.29667, -122.48830),
            'HCB003': (47.53833, -123.00830),
            'HCB004': (47.35667, -123.02330),
            'ADM003': (47.87917, -122.48180),
            'PSB003': (47.66000, -122.44170),
            'SIN001': (47.55000, -122.64170),
            'EAP001': (47.41667, -122.38000),
            'CMB003': (47.29000, -122.44830),
            'CSE001': (47.26500, -122.84330),
            'GOR001': (47.18333, -122.63330),
            } 
